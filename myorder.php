        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item active" href="myorder.php">Myorder</a>
        ...
        if ($_SESSION['admin']['email'] == $row['email']) { ?>
            <div class="container mt-5 d-flex justify-content-center">
                <div class="p-4 mt-3" style="border:2px solid silver;border-radius: 5px; background-color: white; width: 800px;">
                    <p style="font-size: 25px; font-weight:600; text-decoration: underline;" class=" d-flex justify-content-center">My Order</p>
                    ...
                    <div class="info">
                        ...
                        <p class="mt-2" style="margin-bottom: 0; font-weight: 600; color: black;">Your Product -
                    ...
                    <hr>
                    <div class="text">
                        <span class="d-block mb-1" style="font-weight: 500; color: black;"><?php echo ucwords($row['firstname'] . ' ' . $row['lastname']); ?></span>
                    </div>
                    <div class="text">
                        <span class="d-block mb-1" style="font-weight: 500; color: black;"><?php echo $row['email']; ?></span>
                    </div>
                    <p class="mt-2" style="margin-bottom: 0; font-weight: 600; color: black;">Address :- </p>
                    ...
                    <hr>
                    <p style="font-size: 20px; font-weight:500;" class=" d-flex justify-content-center">Order Status</p>
                    <?php if (($row['order_status']) == 'Delivery Soon') { ?>
                        <div class="d-flex flex-row mt-2 align-items-center">
                            <img src="../online-shop-website-template/img/fast-delivery.png" width="30" />
                            <span class="ml-3"><?php echo $row['order_status']; ?></span>
                        </div>
                    <?php } else { ?>
                        <div class="d-flex flex-row mt-2 align-items-center">
