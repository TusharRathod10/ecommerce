  ...
  <body>
        ...
        <?php include('../config/header.php') ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h2 class="fw-bold py-3 mb-4">SubCategory</h2>
              <p id='success'></p>
              <!-- Basic Bootstrap Table -->
              <div class="card ">
                 
              <div class="container d-flex justify-content-end my-2">
                <a href="add-subcategory.php"> <button type="submit" class="btn btn-primary">Add Sub-Category</button></a>
                </div>
    ...
    <script>
      ...
      function delete_subcategory(id) {
        $.ajax({
          url: 'delete_subcategory.php?delete_user=' + btoa(id),
          type: 'POST',
          success: function (response) {
            fetchdata();
