...
<body>
                    ...
                    <a class="text-decoration-none" href="index.php?cat=<?php echo $row['categories']; ?>">
                        <div class="cat-item d-flex align-items-center mb-4 p-2">
                            ...
                            <div class="flex-fill pl-3">
                                ...
                                <?php
                                $name = $row['categories'];
                                $run = mysqli_query($con, "SELECT * FROM product WHERE category='$name'");
                                $total_product = mysqli_num_rows($run);
                                ?>
                                <small class="text-body"><?php echo $total_product ?> Products</small>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <?php $getproduct = mysqli_query($con, "SELECT * FROM product ORDER BY `id` DESC LIMIT 8"); ?>
        <div class="row px-xl-5">
            <?php while ($row2 = mysqli_fetch_assoc($getproduct)) { ?>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
