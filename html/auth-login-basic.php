        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
             ...
             <span class=" demo menu-text fw-bolder ms-2" style="font-size: 25px; color: black;">Login</span>
                </a>
              </div>
              ...
              <form id="form" class="mb-3" action="index.php" method="POST">
                <div class="mb-3">
                  <label for="email_number" class="form-label">Email / Mobile Number</label>
                  <input
                    type="text"
                    class="form-control"
                    id="email_number"
                ...
                <p id="email_number_err" class='error' style="color:red; font-weight: bold;"></p>
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" name="submit" value="submit" id="submit" >Sign in</button>
                </div>
              </form>
        ...
        $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('#email_number_err').text("");
                    $('#password_err').text("");
                    $('#error').text("");
                    var x = JSON.parse(response);                  
                    if (x.status == 400) { console.log(x);
                        $('#email_number_err').text(x.email_number_err);
